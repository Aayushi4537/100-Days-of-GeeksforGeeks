...
void convert(Node *head, TreeNode *&root) {
    ...
    // Use a queue to manage the insertion order
    queue<TreeNode*> q;
    q.push(root);
    ...
    while (head != NULL) {
        ...
        // Create the left child and attach it to the current node
        if (head != NULL) {
        ...
        // Create the right child and attach it to the current node
        if (head != NULL) {
